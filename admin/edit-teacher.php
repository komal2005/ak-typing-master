...
if(isset($_POST['updatebtn']))
{
	...
	$update="UPDATE `teachers` SET name='$name', email='$email',status='$status' WHERE id='$id'";
 ...
 <?php
  ...
  ?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Edit Teachers form </h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
                <!-- begin col-6 -->
			    <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title"><center>Edit Teachers Form</center></h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                         ...
                         <form  action="" class="form-horizontal" data-parsley-validate="true" name="demo-form" method="post">
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<select class="form-control" id="select-required" name="status" data-parsley-required="true">
											<option value="<?php echo $row['status']; ?>">Please select Status</option>
                               ...
                               <div class="form-group row m-b-0">
									...
									<div class="col-md-8 col-sm-8">
									   ...
									   <a href="list-teacher.php" class="btn btn-danger"><center>cancel</center></a>
                                    </div>
                                </div>
