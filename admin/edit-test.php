...
if(isset($_POST['updatebtn']))
{
	...
	$update="UPDATE `test_type` SET name='$name',status='$status' WHERE id='$id'";
...
if(isset($_GET['id']))
	{
			$id = $_GET['id'];
			$select = "select * FROM test_type where id='$id'";
            				...
            				<div class="form-group row m-b-15">
                               ...
                               <div class="form-group row m-b-0">
									...
									<div class="col-md-8 col-sm-8">
									   ...
									   <a href="list-test.php" class="btn btn-danger"><center>cancel</center></a>
                                    </div>
                                </div>
