...
if(isset($_POST["add"]))
{
    ...
    $select = mysqli_query($conn,'SELECT email from teachers where email="'.$email.'"');
       if (mysqli_num_rows($select) == 1)
        ...
        {
    		$insert = "INSERT INTO `teachers`(`name`, `email`, `password`, `status`) 
...
?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Add Teachers Form </h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
                <!-- begin col-6 -->
			    <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title"><center>Add Teachers Form</center></h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
								...
								<div class="form-group row m-b-15 <?php echo ($msg) ? 'has-error' : ''; ?>">
									...
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="email" id="email" name="email" value="<?php echo isset($_POST['email']) ? $_POST['email'] : '';?>"
										 data-parsley-type="email" placeholder="Enter Email" data-parsley-required="true" />
